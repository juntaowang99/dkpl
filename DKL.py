...
np.savetxt("forward_time_dkl_%s.csv"%data_name, np.array(forward_time), delimiter=",")
np.savetxt("backward_time_dkl_%s.csv"%data_name, np.array(backward_time), delimiter=",")
np.savetxt("epoch_time_dkl_%s.csv"%data_name, np.array(epoch_time), delimiter=",")