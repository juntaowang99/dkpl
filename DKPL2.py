...
np.savetxt("forward_time_dkpl_%s.csv"%data_name, np.array(forward_time), delimiter=",")
np.savetxt("backward_time_dkpl_%s.csv"%data_name, np.array(backward_time), delimiter=",")
np.savetxt("epoch_time_dkpl_%s.csv"%data_name, np.array(epoch_time), delimiter=",")